...
<head>
  ...
  <title>Admin - Toko Lestari</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="../../index2.html" class="logo">
        ...
        <span class="logo-lg"><b>TOKO</b> LESTARI</span>
      </a>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview ">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ route('supplier.index') }}"><i class="fa fa-circle-o"></i> List Supplier</a></li>
          ...
          <li class="treeview ">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ route('user.index') }}"><i class="fa fa-circle-o"></i> Daftar User</a></li>
              {{-- <li><a href="{{ route('admin.user.create') }}"><i class="fa fa-circle-o"></i> Add User</a>
          </li> --}}
        </ul>
        </li>
        <li><a href="{{ route('transaction.index') }}"> <i class="fa fa-shopping-cart"></i>
